...
const ctrlblk_$scriptletName$ = function() {
...
// Firefox
{
    ...
    let script, url;
    try {
        page.ctrlblk_$scriptletName$ = cloneInto([
            [ '(', ctrlblk_$scriptletName$.toString(), ')();' ],
            { type: 'text/javascript; charset=utf-8' },
        ], self);
        const blob = new page.Blob(...page.ctrlblk_$scriptletName$);
    ...
    delete page.ctrlblk_$scriptletName$;
}
